export default {
    ...
    queries: [
        ...
        },
        {
            ...
            maxzoom: 10,
            sql:
                "SELECT id, tags, geom FROM osm_relations_z$zoom WHERE tags ->> 'highway' IN ( 'motorway', 'motorway_link',  'trunk',  'primary', 'secondary')",
        },
        {
            minzoom: 10,
            maxzoom: 12,
        ...
        },
        {
            ...
            maxzoom: 13,
            sql:
                "SELECT id, tags, geom FROM osm_relations_z$zoom WHERE tags ->> 'highway' IN ( 'motorway', 'motorway_link',  'trunk', 'trunk_link',  'primary', 'primary_link',  'secondary', 'secondary_link',  'tertiary', 'tertiary_link', 'unclassified', 'residential')",
        },
        {
            minzoom: 13,
            maxzoom: 20,
        ...
        },
        {
            ...
            maxzoom: 20,
            sql:
                "SELECT id, tags, geom FROM osm_relations_z$zoom WHERE tags ? 'highway'",
        },
    ],
}
