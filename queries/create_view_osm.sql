...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 0)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 1)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 2)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 3)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 4)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 5)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 6)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 7)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 8)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
...
SELECT id, tags, geom
FROM (
    SELECT id, tags, st_simplifypreservetopology(geom, 78271.516953125 / POWER(2, 9)) as geom
    FROM osm_ways
    WHERE tags ?| ARRAY[
        'aeroway', 'amenity', 'boundary', 'amenity', 'highway', 'man_made',
        'landuse', 'natural','power', 'railway', 'route', 'waterway'
